...
const TradingTools: React.FC = () => {
    ...
    const calculateResult = () => {
        if (selectedTool === 'Profit & Loss') {
        ...
        } else if (selectedTool === 'Return on investment') {
            ...
            const riskReward = ((inputs.profitTarget - inputs.entryPrice) / (inputs.entryPrice - inputs.stopLoss)).toFixed(2);
    ...
    return (
        <div className="page">
            <div className="tool-buttons">
                ...
                <button onClick={() => handleToolSelection('Return on investment')}>Return on investment (ROI)</button>
            ...
            {selectedTool && (
                <div className="tool-inputs">
                    ...
                    {selectedTool === 'Return on investment' && (
                        <div>
                            <input type="number" name="initialInvestment" placeholder="Initial investment" onChange={handleInputChange} />
                            <input type="number" name="finalValue" placeholder="Final value" onChange={handleInputChange} />
                        </div>
                    )}
                    ...
                    {result !== null && selectedTool === 'Return on investment' && (
                        <div className="result-box">
